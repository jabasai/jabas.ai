...
module.exports = function renderScripts() {
    ...
    const copyright = `/*!
* JABAS - ${packageJSON.title} v${packageJSON.version} (${packageJSON.homepage})
* Copyright 2024-${new Date().getFullYear()} ${packageJSON.author}
* Licensed under ${packageJSON.license} (https://github.com/jabasai/${packageJSON.name}/blob/master/LICENSE)
*/
`
